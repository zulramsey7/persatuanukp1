...
import { z } from "zod";
import { sanitizeInput, sanitizeName, sanitizeEmail, sanitizePhoneNumber, isValidMalaysianPhone, isValidHouseNumber } from "@/lib/sanitize";
...
const Auth = () => {
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    } else if (name === "nama_penuh") {
      sanitizedValue = sanitizeName(value);
    } else if (name === "no_rumah") {
