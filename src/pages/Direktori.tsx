...
const Direktori = () => {
  ...
  const getPrimaryRole = (roles: string[] | undefined) => {
    ...
    // Priority order: Pengerusi > Naib Pengerusi > Setiausaha > Penolong Setiausaha > Bendahari > AJK > Ahli
    const rolePriority = [
      'pengerusi',
      'naib_pengerusi', 
      'setiausaha',
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-1 flex-wrap">
                        <Badge variant="outline" className="text-xs px-2 py-0.5 bg-background/50">
                          No. {String(member.member_number || member.no_ahli || index + 1).padStart(3, '0')}
                        </Badge>
                        {(() => {
