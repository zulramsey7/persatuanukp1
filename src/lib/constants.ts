...
export const CONTACT_INFO = {
  TREASURER_WHATSAPP: '01111076900', // Replace with actual treasurer WhatsApp number
  ASSOCIATION_EMAIL: 'persatuanukayperdana@gmail.com',
  BANK_NAME: 'BANK RAKYAT',
  BANK_ACCOUNT_NO: '1102395072',
  BANK_ACCOUNT_NAME: 'PERSATUAN PENDUDUK TAMAN UKAY PERDANA UP 1',
} as const;
