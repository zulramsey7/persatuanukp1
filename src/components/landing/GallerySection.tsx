        ...
        >
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold text-foreground">
              Galeri <span className="bg-gradient-to-r from-primary via-primary/80 to-primary/60 bg-clip-text text-transparent">Aktiviti</span>
            </h2>
            <div className="h-8 w-1 bg-gradient-to-b from-primary/50 to-transparent rounded-full" />
          </div>
